    ...
    >
      <div className="absolute -translate-x-1/2" style={{ top: '-1px' }}>
        <svg
          ...
          className="drop-shadow-[0_0_8px_rgba(37,217,239,0.8)]"
        >
          <path d="M0.5 0H12.5V8L6.5 14L0.5 8V0Z" fill="#4AA8FF" />
        </svg>
      </div>
      <div
        className="absolute w-px bg-primary shadow-[0_0_10px_#4AA8FF]"
